      ...
      <div className="w-full h-full flex flex-col justify-center items-center bg-slate-400">
        <div className="w-[70%] h-2/3 flex flex-col gap-4 justify-center">
          <div className="w-full flex gap-x-4 px-12">
            <h1 className="text-left text-6xl font-poppins font-black text-[#0066de] ">
              1600/1600{" "}
            </h1>
            <span className="animate-SlidefromRight text-left text-6xl font-poppins font-black text-[#0066de]">
              {" "}
              Can Be Achieved
            </span>
          </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 mb-10 flex justify-center z-20">
            <div className="w-[100%] grid grid-cols-5 gap-2">
              <div className="backdrop-blur-md  h-20 flex justify-center items-center animate-SlidefromLeft">
                <div className="px-8 py-2  bg-[#0066de] text-white font-plusjakartasans font-bold">
                  Without mind SAT
                </div>
              </div>
              ...
              <div className="backdrop-blur-md  h-20 flex justify-center items-center">
                <div className="px-8 py-2  bg-[#0066de] text-white font-plusjakartasans font-bold animate-SlidefromRight">
                  With mind SAT
                </div>
              </div>
            </div>
