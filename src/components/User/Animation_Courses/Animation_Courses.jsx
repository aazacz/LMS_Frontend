  ...
  <div className="animation-courses-maths">
    <div className="animation-courses-maths-sub1 ">
      ...
      <div className="maths-sat-content">
        ...
        porro iure quo voluptate omnis alias praesentium qui reiciendis nobis.
        <br /> Corporis soluta eaque a accusamus neque provident et ab aliquam
        adipisci!
      </div>
      <div className="maths-sat-review">
        {" "}
        &#x275D; The course was beautifully conceptualized and well presented.
    ...
    <div className="animation-courses-maths-sub2">
      <div className="maths-sat-programme1 ">
        ...
        <div className="maths-sat-programme1-type ">Self Assessment Test</div>
        <div className="maths-sat-programme1-title">MATHS SAT</div>
        <div className="maths-sat-programme1-desc">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Minus,
          perferendis? Non fugit expedita error consectetur!{" "}
        </div>
