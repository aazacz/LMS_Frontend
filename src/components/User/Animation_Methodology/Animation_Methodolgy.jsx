        ...
        <div className="animation-methodology-main-conatainer  ">
            <div className="animation-methodology-title-conatainer">
                ...
                <div className="header text-left">
                    <h1 className="animation-methodology-main-title w-full text-left ">
                        Our Methodology
                    </h1>
                </div>
                <div className="animation-methodology-sub-title">
                    Create Effective Habits by Encouraging Efforts only.Results
                    Follow.
                </div>
            </div>
            ...
            <div className="animation-methodolgy-content-container">
                <div className="animation-methodology-content-card1">
                    <div className="animation-metodology-content-card-number ">
                        01
                    </div>
                    ...
                    <div className="animation-methodology-card-desc">
                        ...
                        Veritatis obcaecati, saepe rem itaque suscipit
                        aspernatur, porro expedita dolorem assumenda et
                        praesentium eaque in nesciunt, debitis veniam sequi.
                        Debitis, corrupti animi.
                    </div>
                </div>
