        ...
        <div className="grid justify-evenly w-full grid-cols-1 gap-5 xs:grid-cols-2">
          <div className="animation-tutor-tutor">
            ...
            <div className="animation-tutor-content">
              ...
              <h3>
                Science Specialist (10 years) <br /> Taught up to 100+ PU
                Students
              </h3>
            </div>
          </div>
          ...
          <div className="animation-tutor-tutor">
            ...
            <div className="animation-tutor-content">
              <h1>Micheal Steel</h1>
              <h3>
                Math Specialist (12 years) <br /> Taught up to 100+ PU Students
              </h3>
            </div>
          </div>
        </div>
      ...
      <div className="animation-tutor-sub-container2">
        <div className="animation-tutor-tutor">
          ...
          <div className="animation-tutor-content">
            <h1>Steven Barley</h1>
            <h3>
              Math Specialist (10 years) <br /> Taught up to 100+ PU Students
            </h3>
          </div>
        </div>
        <div className="animation-tutor-tutor">
          ...
          <div className="animation-tutor-content">
            ...
            <h3>
              Biology Specialist (10 years) <br /> Taught up to 100+ PU Students
            </h3>
          </div>
        </div>
        <div className="animation-tutor-tutor">
        ...
        <div className="animation-tutor-tutor">
          ...
          <div className="animation-tutor-content">
            <h1>David Steel</h1>
            <h3>
              Math Specialist (15 years) <br /> Taught up to 100+ PU Students
            </h3>
          </div>
        </div>
      </div>
