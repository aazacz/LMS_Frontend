            ...
            <div className="animation-tutor-sub-conatainer1">
                <div className="animation-tutor-sub-container-content ">
                    ...
                    <div className="animation-tutor-sub-conatiner-desc ">
                        ...
                        the experimenatation of the message and smart incentives
                    </div>
                ...
                <div className="animation-tutor-tutor1">
                    ...
                    <div className="animation-tutor-content">
                        ...
                        <h3>
                            Science Specialist(10 years) <br /> Teached upto
                            100+ PU Students
                        </h3>
                    </div>
                </div>
                ...
                <div className="animation-tutor-tutor1">
                    ...
                    <div className="animation-tutor-content">
                        <h1>Micheal Steel</h1>
                        <h3>
                            Math Specialist(12 years) <br /> Teached upto 100+
                            PU Students
                        </h3>
                    </div>
                </div>
            ...
            <div className=" animation-tutor-sub-conatainer2">
                <div className="animation-tutor-tutor1">
                    ...
                    <div className="animation-tutor-content">
                        <h1>Steven Barley</h1>
                        <h3>
                            Math Specialist(10 years) <br /> Teached upto 100+
                            PU Students
                        </h3>
                    </div>
                </div>
                <div className="animation-tutor-tutor1">
                    ...
                    <div className="animation-tutor-content">
                        ...
                        <h3>
                            Biology Specialist(10 years) <br /> Teached upto
                            100+ PU Students
                        </h3>
                    </div>
                </div>
                ...
                <div className="animation-tutor-tutor1">
                    ...
                    <div className="animation-tutor-content">
                        <h1>David Steel </h1>
                        <h3>
                            Math Specialist(15 years) <br /> Teached upto 100+
                            PU Students
                        </h3>
                    </div>
                </div>
