                    ...
                    <div className="  left-content  flex-wrap">
                        ...
                        <div className="left-sub-content2 p-2 m-2 w-full  lg:w-[50%]">
                            ...
                            <div className="left-sub-content2-heading">
                                <h1>David Beckham</h1>
                                <p>
                                    The community's need for applications that
                                    can facilitate dailty activities is
                                    increasing as technology
                                    advaces.Currently,The community's need for
                                    applications that can facilitate daily
                                    activities is increasing as technology
                                    advances,Currently.
                                </p>
                            </div>
                            <div className="left-sub-content2-buttons">
                                <button
                                    type="button"
                                    className="join-now-button common-button"
                                >
                                    Join Now
                                </button>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-2 bg-gray-100">
                                <div className="p-4 flex flex-col gap-4">
                                    ...
                                    <p className="text-sm">
                                        Complete The Test 1 before proceeding
                                        for the next module.
                                    </p>
