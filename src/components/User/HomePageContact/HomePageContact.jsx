      ...
      <div className="HomePageContact-main-container  " >
        ...
        <div className="HomePageContact-sub-container2 ">
          ...
          <div className="HomePageContact-details-conatiner2 ">
            <div className="HomePageConatct-details-support-call ">📞Call</div>
            <h2 className="text-xs font-bold cursor-pointer mb-10 ml-6">Schedule a Call </h2>
            <div className="HomePageConatct-details-support-call ">🐞Bug</div>
            <h2 className="text-xs font-bold cursor-pointer mb-10 ml-6">Report a Bug </h2>
            <div className="HomePageConatct-details-support-call">❓Help</div>
            <h2 className="text-xs font-bold cursor-pointer mb-10 ml-6">Ask any Question </h2>
            <div></div>
            </div>
          </div>
        </div>
