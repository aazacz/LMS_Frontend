    ...
    return (
        <div className="container">
            <div className="left">
                ...
                <p className="left-sub-heading">
                    Get 30% off your first year on Unlimited online courses.
                </p>
                <p className="left-sub-sub-heading">
                    Invest in your future with Unlimited access to 1400+
                    high-quality short courses and digital certificates from
            ...
            <div className="right">
                <div className="right-box">
                    ...
                    <p>
                        If you had already appeared for the test, Upload your
                        test score to directly enroll into a course based on
                        suggestions
                    </p>
