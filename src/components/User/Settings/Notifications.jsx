        ...
        <div className="h-screen overflow-y-scroll no-scrollbar notification-settings">
            ...
            <div className="email-notifications">
                ...
                <p>
                    ...
                    notifications for any new direct messages or mentions of
                    your name.
                </p>
                <div className="radio-group">
                    ...
                    <label htmlFor="email-notifications-hour">
                        <input
                            ...
                            checked={
                                emailNotifications === 'Once an hour at most'
                            }
                            onChange={handleEmailNotificationsChange}
                        />
            ...
            <div className="email-news-updates">
                ...
                <p>
                    ...
                    interesting news about Substance and your workspace. You can
