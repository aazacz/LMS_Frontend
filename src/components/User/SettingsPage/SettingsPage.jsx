            ...
            case 'editProfile':
                return (
                    <div className="w-3/4 h-max flex flex-col justify-center items-start pl-2pct gap-4 mr-5mct ">
                        <p className="font-semibold text-lg mb-2mct">
                            Edit Profile
                        </p>
                        ...
                        <div className="w-11/12 md:w-11/12  h-max flex flex-wrap justify-start items-center pr-20pct ">
                            <div className="w-11/12 h-max flex flex-col justify-center items-left gap-6">
                                ...
                                <h5 className="text-xs w-4/5 text-gray-400">
                                    ...
                                    delete your personal data.You can cancel the
                                    deletion for 14 days.
                                </h5>
                                <div className="text-xs text-red-600  ">
                                    <input type="checkbox" /> Confirm that I
                ...
                return (
                    <div className="notification-settings">
                        ...
                        <div className="mobile-push-notification">
                            ...
                            >
                                <option value="All New Messages">
                                    All New Messages
                                </option>
                                <option value="Only Mentions">
                                    Only Mentions
                                </option>
                        ...
                        <div className="email-notifications">
                            ...
                            <p>
                                When you're busy or not online, Substance can
                                send you email notifications for any new direct
                        ...
                        <div className="email-news-updates">
                            ...
                            <p>
                                From time to time, we'd like to send you emails
                                with interesting news about Substance and your
                                workspace. You can choose which of these updates
                            ...
                            <div className="checkbox-group">
                                ...
                                <label htmlFor="offers-and-promotions">
                                    <input
                                        ...
                                        checked={
                                            emailUpdates.offersAndPromotions
                                        }
                                        onChange={handleEmailUpdatesChange}
                                    />
                                ...
                                <label htmlFor="research-opportunities">
                                    <input
                                        ...
                                        checked={
                                            emailUpdates.researchOpportunities
                                        }
                                        onChange={handleEmailUpdatesChange}
                                    />
                            ...
                            <p className="notification-footer">
                                If you opt out of the above, note that we'll
                                still send you important administrative emails.
                            </p>
                        </div>
                    </div>
                )
        ...
        <div className="w-full h-screen  ">
            <div className="w-full h-5/6  flex justify-start items-center flex-wrap flex-col ">
                <div className="w-1/2 md:w-1/3 lg:w-30percent h-5/6 flex flex-col justify-start items-start gap-6  pl-15pct">
                    ...
                    <button
                        className={`bg-white rounded-md text-xs md:text-sm lg:text-sm ${
                            activeButton === 'notificationSettings'
                                ? 'bg-slate-200'
                                : ''
                        }`}
                        onClick={() =>
                            handleButtonClick('notificationSettings')
                        }
                    >
