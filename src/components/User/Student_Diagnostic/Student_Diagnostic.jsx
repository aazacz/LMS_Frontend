  ...
  return (
    <div className="w-screen h-[100vh] relative px-10">
      ...
      <div className="h-max flex-wrap-reverse student-diagnostic-main-container">
        <div className="gap-5 flex flex-col p-4 w-full  md:w-[50%]">
          <div className="student-diagnostic-sub-title flex items-start text-2xl md:text-4xl lg:text-5xl   ">
            &#x275D; Get Your Diagnostic Test Report With Detailed Analysis.You
            Will Get A Customized Study Plan Based On Your Assessment &#x275E;
          </div>
          <Link to={"/diagnosistest/intructions"}>
            <div className="text-sm py-2 px-2 w-full my-4 md:text-lg student-diagnostic-sub-button">
