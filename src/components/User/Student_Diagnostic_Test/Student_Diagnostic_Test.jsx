    ...
    <div className="w-screen h-screen relative">
      <div className="student-diagnostic-test-rules-main-container">
        ...
        <div className="student-diagnostic-test-sub-title">
          <li>
            Total Number of Questions: <span className="text-bold">9</span>
          </li>
          <li>
            Time Alloted: <span className="text-bold">25 mins</span>
          </li>
          <li>
          ...
          <li>
            Saepe iste dignissimos repudiandae possimus, neque deleniti
            laudantium a ab tempora blanditiis ut corporis amet dicta incidunt
            eos eius nobis perspiciatis.
          </li>
        </div>
