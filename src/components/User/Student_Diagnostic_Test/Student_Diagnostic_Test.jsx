...
const Student_Diagnostic_Test = () => {
  ...
  const handleSubmit = () => {
    ...
    if (testDetails) {
      navigate("/diagnosistest/test1", { state: { testId: testDetails._id } });
    } else {
    ...
    <div className="w-screen h-screen relative">
      <div className="student-diagnostic-test-rules-main-container">
          ...
          {testDetails ? (
            <>
              <li>
                ...
                <span className="text-bold">{testDetails.questionCount}</span>
              </li>
              <li>
                Time Alloted: <span className="text-bold">10 mins</span>
              </li>
              <li>
                Each Question Carries:{" "}
                <span className="text-bold">
                  Positive: {testDetails.positiveMark} marks and Negative:{" "}
                  {testDetails.negativeMark} marks
                </span>
              </li>
              <li>Test should be taken in full screen only</li>
              <li>Do not switch tabs </li>
              <li>
                If you are unable to complete the test within the given time
                limit, do not panic. All answered questions will be considered
        ...
        <div className="pt-8 student-diagnostic-test-main-title text-base md:text-lg lg:text-xl">
          {testDetails && (
            <>
              Total {testDetails.questionCount} Questions Positive Marks: +
              {testDetails.positiveMark} | Negative Marks: -{" "}
        ...
        <div className="student-diagnostic-test-sub-title text-base md:text-lg">
          <li>
            Click on submit button given at the bottom of the page to submit
            your exam.
          </li>
        ...
        <p className="text-red-600 text-base lg:text-xl mt-2 font-semibold">
          Do not switch tabs or exit full screen. This will lead to automatic
          submission.
        </p>
        <div
