...
const AddCourseStructure = ({ view }) => {
    ...
    return (
        <div className="w-full pt-4 px-4 md:p-5 md:px-16 bg-slate-200 rounded-lg mt-2">
            ...
            {View ? <div className='w-full flex justify-between'>
                ...
                <MdDelete onClick={()=>handleDeleteCourse} className='text-3xl text-red-600 cursor-pointer ' />  <FaEdit onClick={handleEdit} className='text-3xl text-blue-700 cursor-pointer' />
            </div>
