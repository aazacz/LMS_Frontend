        ...
        <div className="flex-1 h-auto  p-5 bg-slate-200 rounded-2xl mt-5">
            ...
            <form onSubmit={submitHandler} className="space-y-4">
                    ...
                    <div key={qIndex} className="w-full h-auto bg-white rounded-lg p-4 flex flex-col gap-y-4 border-2 border-blue-900 mt-4">
                        ...
                        {question.choices.map((choice, cIndex) => (
                            <div key={cIndex} className={`flex items-center gap-x-2 px-2 rounded-md  `}>
                                ...
                                <div className={`flex w-20  justify-between shadow-[0_3px_10px_rgb(0,0,0,0.2)] ${getBackgroundColor(choice.isCorrect)} px-2 rounded-sm `}>
                                ...
                                className='w-[20%] '
                                    ...
                                    />
                                <label className='w-[90%] text-right font-light font-plusjakartasans text-sm ' >{choice.isCorrect?"True":"False"}</label>
                                    </div>
                            </div>
                        ))}
                ...
                <div className="flex gap-x-7 justify-center">
                    <button className="px-12 py-2 bg-blue-600 rounded-md text-white font-poppins" type="button" onClick={cancelForm}> 
                        Cancel
                    </button>
                    <button className="px-12 py-2 bg-green-600 rounded-md text-white font-poppins" type="submit">
                        Create Test
                    </button>
                </div>
            </form>
