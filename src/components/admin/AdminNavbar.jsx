...
const AdminNavbar = ({ toggleSidebar,isSidebarOpen,name }) => {
      ...
      <div className='navbar-container md:px-4 b  px-2 sticky top-0 w-full h-[10vh]   border-b-[1px] flex justify-between items-center  bg-white     '>
        ...
        <div className='w-[40%] flex justify-end  h-max  '>
          ...
          <div className='flex items-center'>
            ...
            {/* hamburger button */}
            {isSidebarOpen ? <FaBookOpen  onClick={() => toggleSidebar()} className='block md:hidden z-30  text-2xl ' />
                    : <FaBook onClick={() => toggleSidebar()} className='block md:hidden z-30  text-2xl ' />
                  }          
