        ...
        <div className='w-full h-8 flex items-center bg-white rounded-lg  gap-x-3 border-[1px] border-black'>
                ...
                <div className='w-full  pt-4  flex justify-end '> 
                     ...
                     <div className='w-[80px]  flex  items-center '> 
                        ...
                        className={`${ListModal?"text-blue-700":"text-gray-500"} cursor-pointer w-1/2 h-full flex justify-center border-r-[2px] border-gray-600 `}>
                             <FaList className='text-lg '/>  </div>
