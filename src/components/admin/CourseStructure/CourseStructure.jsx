...
const CourseStructure = () => {
  ...
  useEffect(() => {
    axios
      .get(`${baseURL}api/package/get-all-package?page=1&pageSize=1`, {
  ...
  const submitHandler = async (event) => {
    ...
    try {
      ...
      axios
        .post(`${baseURL}api/structure/create`, course, {
          "user-agent": navigator.userAgent,
        })
        .then((res) => {
      ...
      <div>
        <form onSubmit={(e) => submitHandler(e)} className="space-y-6">
          ...
          {course.modules.map((module, moduleIndex) => {
            ...
            return (
              <div
                className=" w-full h-auto bg-white rounded-lg p-4  flex flex-col gap-y-4 border-2 border-blue-900"
                key={moduleIndex}
              >
                {/* Module Counter */}
                <div className="">
                  <div className="w-7 h-7 border-2 border-blue-900 rounded-md flex justify-center items-center">
                    <h1 className="font-Roboto font-medium text-blue-900">
                      {moduleIndex + 1}{" "}
                    </h1>
                  </div>
                </div>
                ...
                {module.sessions.map((session, sessionIndex) => (
                  <div
                    key={sessionIndex}
                    className=" border-2 border-blue-200 p-6  rounded-xl"
                  >
                    <div className="">
                      <div className="w-5 h-5 border-[1px] border-gray-700 flex justify-center items-center">
                        <h1 className="font-Roboto font-extralight ">
                          {sessionIndex + 1}{" "}
                        </h1>
                      </div>
                    </div>
                    <div className="w-full ">
                      ...
                      <input
                        onChange={(e) =>
                          handleSessionInputChange(e, moduleIndex, sessionIndex)
                        }
                        type="text"
                        name="sessionName"
                    ...
                    <div className="w-full grid grid-flow-row grid-cols-2 gap-x-4 mt-3">
                      ...
                      <div className="w-full ">
                        ...
                        />
                        {errors[
                          `modules[${moduleIndex}].sessions[${sessionIndex}].sessionDateTime`
                        ] && (
                          <p className="text-red-500 text-xs">
                            {
                              errors[
                      ...
                      <div className="w-full ">
                        ...
                        />
                        {errors[
                          `modules[${moduleIndex}].sessions[${sessionIndex}].sessionLink`
                        ] && (
                          <p className="text-red-500 text-xs">
                            {
                              errors[
                ...
                <div className="flex justify-end mt-3">
                  <button
                    ...
                    className="flex gap-3  p-2 text-sm font-poppins content-center items-center rounded-lg bg-slate-600 text-white hover:bg-blue-800"
                  >
