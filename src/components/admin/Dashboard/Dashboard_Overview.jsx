...
const Dashboard_Overview = () => {
    ...
    return (
        <div className=" w-auto h-max flex flex-col bg-[#E0EDFB] p-2 rounded-md shadow-md  ">
            <div className="w-auto  h-1/5 flex justify-between items-center ">
            ...
            <div className="w-auto   h-4/5 flex flex-wrap ">
                ...
                <div className="w-full md:w-[65%] h-max ">
                    <Histogram />
                </div>
            </div>
        </div>
