...
const DiagnosisiTestDetailsPage = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `${baseUrl}api/diagnosis/diagnosis-tests/${diagnosisTestDetailsPage}`
      )
      .then((res) => {
  ...
  return (
    <div className="container h-screen overflow-y-auto mx-auto p-4 flex flex-col items-center justify-center">
      <button
