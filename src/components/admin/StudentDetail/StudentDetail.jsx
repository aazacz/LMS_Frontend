  ...
  return (
    <div className="student-detail-container">
      ...
      <div className="student-detail-courses">
        ...
        <p onClick={() => setShowAllCourses(!showAllCourses)} style={{ cursor: 'pointer', color: 'blue' }}>
          View all ➡️
        </p>
      </div>
      ...
      <div className="student-detail-cards grid grid-flow-row grid-cols-1 sm:grid-cols-2 tb:grid-cols-2 tab:grid-cols-3 lg:grid-cols-4">
        {courses.slice(0, showAllCourses ? courses.length : 4).map((course, index) => (
          <CourseCard
            key={index}
            title={course.title}
            days={course.days}
      ...
      <div className="student-detail-courses">
        <p>📖 Assignments</p>
        <p onClick={() => setShowAllAssignments(!showAllAssignments)} style={{ cursor: 'pointer', color: 'blue' }}>
          View all ➡️
        </p>
      </div>
      <div className="student-detail-line"></div>
      <div className="student-detail-cards grid grid-flow-row grid-cols-1 sm:grid-cols-2 tb:grid-cols-2 tab:grid-cols-3 lg:grid-cols-4">
        {assignments.slice(0, showAllAssignments ? assignments.length : 4).map((assignment, index) => (
          <AssignmentCard
            key={index}
