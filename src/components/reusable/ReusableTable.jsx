    ...
    try {
      await axios
        ...
        .then((response) => {
          ...
          if (
            response.data.message === "Diagnosis Test activated successfully"
          ) {
                ...
                {columns.map((column, index) => (
                  <td key={index}>
                    ...
                    {column.field === "button" ? (
                      <div
                        onClick={() => {
                          navigate("/admin/home/diagnosistest/" + row._id);
                        }}
                    ...
                    {column.field === "status" ? (
                      <div className="action-container">
                        {Active ? (
                          <div
                            onClick={() =>
                              handleDiagnosisTestActive("active", row._id)
                            }
                          ...
                          <div
                            onClick={() =>
                              handleDiagnosisTestActive("inactive", row._id)
                            }
