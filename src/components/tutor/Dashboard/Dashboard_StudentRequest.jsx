...
const Dashboard_StudentRequest = () => {
  ...
  return (
    <div className="w-full h-max flex flex-col shadow-md bg-[#E5F0FC] p-2">
      ...
      <div className="w-[100%] h-[228px] max-h-200 overflow-y-scroll no-scrollbar p-4">
        {data.map((item, index) => (
          <div
            key={index}
            className="w-full flex flex-col justify-start items-start border-b-2 border-dashed p-2 border-gray-500"
          >
