  ...
  return (
    <div className="new-course-container">
      <div className="new-course">
        ...
        <p className="new-course-instruction">Teaching Grade of Students*</p>
        <select
          name="course-grade"
          id="course-grade"
      ...
      <div className="course-date-time">
        ...
        <div className="time-container">
          <div className="new-course-duration">
            <p className="new-course-instruction">Training Duration</p>
            <input
              type="text"
          ...
          <div className="new-course-duration">
            <p className="new-course-instruction">No of Hours Per Day</p>
            <select
              name="course-grade"
              id="course-grade"
              className="new-course-grade-duration"
