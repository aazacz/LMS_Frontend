...
const TestTable = ({ handleView, handleReview }) => {
  ...
  const columns = [
    ...
    { field: "negativeMark", headerName: "Negative Mark" },
    { field: "totalQuestions", headerName: "Total Questions" },
    { field: "totalSubmissions", headerName: "Total Submissions" },
    { field: "actions", headerName: "Actions" },
  ];
            ...
            {isPending ? (
              ...
              tests.map((test, index) => (
                <tr key={test._id} className="text-gray-700 font-extralight">
                  ...
                  <td>{test.positiveMark}</td>
                  <td>{test.negativeMark}</td>
              ...
              <tr>
                <td colSpan={columns.length}>
                  <div className="w-full text-center py-4">No tests available</div>
                </td>
              </tr>
            )}
          </tbody>
