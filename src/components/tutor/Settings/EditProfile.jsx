...
const EditProfile = () => {
    ...
    if (selectedImage) {
      ...
      try {
        const response = await TutorAxiosInstance.post(
          "api/tutorsettings/upload-tutor-profile-photo",
          formData,
          {
            headers: {
  ...
  return (
    <div className="w-full p-2 flex flex-col justify-center items-start gap-4 font-poppins relative border-red-800">
        ...
        <div className="relative">
          <div className="rounded-full overflow-hidden object-cover w-28 h-28 md:w-32 md:h-32 lg:w-32 lg:h-32">
            {selectedImage ? (
              ...
              <img
                src={details.tutorImg || Settings1} // Ensure this key matches the state
                alt="Profile picture"
              />
            )}
      ...
      <form className="w-full">
        ...
        <button
          type="button"
          className="w-full py-2 bg-blue-500 font-semibold text-sm text-white rounded-md mb-5"
