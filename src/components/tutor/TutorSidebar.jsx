...
// const TutorSideBar = ({ isSidebarOpen, setIsSidebarOpen }) => {
//   const [collapsed, setCollapsed] = useState(false);
//   const location = useLocation();
//   const navigate = useNavigate();
//   const dispatch = useDispatch();
...
//       title: 'Content',
//       path: '/tutor/home/content',
//       icon: <MdContentPaste className="text-xl text-gray-900" />,
//     },
//     {
//       title: 'Question Bank',
//       path: '/tutor/home/questionbank',
//       icon: <FaClipboardQuestion className="text-xl text-gray-900" />,
//     },
//     {
//       title: 'Students',
//       path: '/tutor/home/students',
//       icon: <PiStudentFill className="text-xl text-gray-900" />,
//     },
//     {
//       title: 'Grading',
//       path: '/tutor/home/grading',
//       icon: <MdGrading className="text-xl text-gray-900" />,
//     },
//     {
//       title: 'Materials',
//       path: '/tutor/home/allmaterials',
//       icon: <IoLibrarySharp className="text-xl text-gray-900" />,
//     },
//     {
//       title: 'Settings',
...
//   return (
//     <div
//       className={`h-screen bg-white overflow-y-auto absolute md:sticky z-50 ${
//         isSidebarOpen ? '' : ' -translate-x-full md:translate-x-0'
//       } transition-all duration-500 font-poppins text-sm font-medium`}
//     >
//       <Sidebar collapsed={collapsed} backgroundColor="#fff" width="210px">
...
//           <MenuItem
//             onClick={handleLogout}
//             className={`side-menu-item mt-20 ${
//               isActive('/') ? 'bg-blue-500 text-red-500 ' : 'side-menu-item'
//             }`}
//             icon={<IoLogOut />}
//           >
//             Logout
