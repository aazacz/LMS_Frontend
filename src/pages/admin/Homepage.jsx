            ...
            <div className="w-full   ">
              <Routes>
                ...
                <Route
                  ...
                  element={<AddCourse edit={false} />}
                />
                <Route
                  path="/courses/editcourse/:courseId"
                  element={<AddCourse edit={true} />}
                />
                <Route path="/courses" element={<CourseList />} />
                <Route
                  path="/courses/:courseId/:courseType/:enrolled/:role"
                  element={<Coursedetails edit={false} />}
                />
                <Route
                  path="/courses/:courseId/:courseType/:enrolled/:role"
                  element={<Coursedetails edit={true} />}
                />
                ...
                <Route
                  ...
                  element={<AddCourseStructure view={false} />}
                />
                <Route
                  path="/courseStructure/viewcoursestructure/:structureId"
                  element={<AddCourseStructure view={true} />}
                />
                <Route
                ...
                />
                <Route
                  path="/coursestructure/editcoursestructure/:structureId"
                  element={<AddCourseStructure view={false} />}
                />
                ...
                />
                <Route
                  path="/diagnosistest/:diagnosisTestDetailsPage"
                  element={<DiagnosisiTestDetailsPage />}
                />
                <Route
                  path="/diagnosistest/edit/:testId"
                  element={<EditDiagnosistest />}
                />
