...
const DiagnosisTest = () => {
  ...
  return (
    <>
      ...
      {/* ${loading ? "blur-md":""} */}
      <div
        className={` Test w-screen h-screen flex overflow-y-scroll relative`}
      >
        {/*BODY CONTENT  */}
        <div className="max-w-[1000px] w-full p-5 h-full">
          ...
          <div className="w-full grid grid-flow-row grid-rows-4 gap-y-4">
        ...
        <div className="fixed bottom-0 w-full h-14 px-8 bg-white shadow-[0px_0px_6px_8px_#00000024] flex justify-between items-center">
          <div className="flex gap-x-5">
            <button className="px-6 font-semibold font-poppins text-sm border-[1px] border-black py-2 rounded-lg">
